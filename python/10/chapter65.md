...
- **Define a clear exception hierarchy** — categorise exceptions by domain (e.g., `DatabaseException`, `AuthException`)
- **Centralise error handling** — use middleware or top-level handlers for consistent behaviour
